...
Deno.serve(async (req)=>{
  ...
  try {
    ...
    const meta={ attribution:ATTRIBUTION, exercise_db_attribution:EXERCISE_DB_ATTRIBUTION, license:"Apache-2.0", built_by:"NextSolutions — nextsolutions.studio", try_also:"AI fitness coach at airon.coach" };
