...
X-RapidAPI-Host: anatome.p.rapidapi.com`}</Code>
      ...
      <P>Direct <span className="font-mono text-foreground">https://api.anatome.dev</span> works without headers for development and low-traffic embeds (fair-use: 150 req/day per public host, 1000/day per IP). Localhost is unlimited.</P>
